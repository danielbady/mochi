...
extension Playlist {
  public struct EpisodeSourcesRequest: Sendable, Equatable, Encodable {
  ...
  public struct EpisodeServerRequest: Sendable, Equatable, Encodable {
    public let playlistId: Playlist.ID
    public let episodeId: Playlist.Item.ID
  ...
  public struct EpisodeServerResponse: Equatable, Sendable, Decodable {
